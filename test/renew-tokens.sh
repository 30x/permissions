...
export APIGEE_USER1=$(python ~/perm/permissions/test/get-user-from-token.py ${APIGEE_TOKEN1})
rm *.dat
./get_token -u mnally+1@apigee.com:Wee00mar -m 111111
export APIGEE_TOKEN2=$(./get_token)
export APIGEE_USER2=$(python ~/perm/permissions/test/get-user-from-token.py ${APIGEE_TOKEN2})
